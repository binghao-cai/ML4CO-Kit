r"""
Models and helper functions for GNN_AStar
"""
    ...
    if network is None:
        ...
        if pretrain and args['use_net']:
            if pretrain in astar_pretrain_path:
                ...
                filename = download(f'best_genn_{pretrain}_gcn_astar.pt', url, md5)
...
class Graphs:
    ...
    def graph_process(self):
        edge_index, edge_weight, _ = dense_to_sparse(self.adj)
